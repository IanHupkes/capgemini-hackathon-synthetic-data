...
def main() -> None:
    ...
    wijk_row = df_kerncijfers[df_kerncijfers["Codering_3"].str.contains(WIJKCODE)].iloc[0]
    ...
    hoogst_behaalde_opleiding = df_onderwijs_2021.groupby(df_onderwijs_2021['HoogstBehaaldOnderwijsniveau'].str[0])['Bevolking_1'].sum() * 1000
    ...
    macro_json = {
            ...
            "marginals": {
                ...
                "arbeidsmarktpositie": {
                    ...
                    "werkloos": wijk_row['AantalInwoners_5'] - (wijk_row['WerkzameBeroepsbevolking_70'] or wijk_row['AantalInwoners_5']),
