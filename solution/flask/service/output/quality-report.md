...
- **Random seed:** None
- **Generator version / git commit:** `4f3da97`
...
|---|---|---|---|
| leeftijd | MAPE | 20.52% | < 5% |
| leeftijd | Total Absolute Error / Total Population | 19.45% | lower is better |
| leeftijd | Chi-square | 183.525 (dof=4) | p > 0.05 |
| huishoudgrootte | MAPE | 1.94% | < 5% |
| huishoudgrootte | Total Absolute Error / Total Population | 1.21% | lower is better |
| huishoudgrootte | Chi-square | 0.738 (dof=2) | p > 0.05 |
